...
if (mysqli_connect_error()) {
   ...
   $sql = "SELECT * FROM letters WHERE final_destination = '$dir' AND status != 'Received'";

   $result = $conn->query($sql);

   if ($result->num_rows > 0) {
      echo "<h2><span class='theme-text'>Incoming</span> <span class='accepted-jobs'>Letters</span></h2>";
      echo "<table>";
      ...
      while ($row = $result->fetch_assoc()) {
         ...
         echo "<td>$sentTo</td>";
         echo "<td>$subject</td>";
        echo "<td><button onclick=\"acceptAssignment('$serial')\">Received</button></td>";
         echo "</tr>";
      }
