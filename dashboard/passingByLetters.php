...
if (mysqli_connect_error()) {
   ...
   $sql = "SELECT * FROM letters WHERE $dir = 'Incoming'";

   $result = $conn->query($sql);

   if ($result->num_rows > 0) {
      echo "<h2><span class='theme-text'>Passing By</span> <span class='accepted-jobs'>Letters</span></h2>";
      echo "<table>";
...
?>
   ...
   function acceptAssignment(id) {
      window.location.href = "receivedIntermediate.php?id=" + id;
   }
</script>
