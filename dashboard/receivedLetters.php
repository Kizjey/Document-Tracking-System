...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default" >
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="index.html"><i class="menu-icon fa fa-laptop"></i> <?php echo $username ?>Dashboard </a>
                    </li>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header" style="background-color: #ECFFDC;">
            <div class="top-left" style="background-color: #ECFFDC;">
                <div class="navbar-header" style="background-color: #ECFFDC; width: 200%;">
                    <a class="navbar-brand" href="../index.html"><img src="sdl.png" alt="" width="200%"></a>
...
if (mysqli_connect_error()) {
   ...
   $sql = "SELECT * FROM letters WHERE final_destination = '$dir'";

   $result = $conn->query($sql);

   if ($result->num_rows > 0) {
      echo "<h2><span class='theme-text'>Sent</span> <span class='accepted-jobs'>Letters</span></h2>";
      echo "<table>";
      ...
      echo "<p>No accepted jobs found in the database.</p>";
   }
