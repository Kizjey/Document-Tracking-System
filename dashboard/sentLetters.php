...
if (mysqli_connect_error()) {
   ...
   $sql = "SELECT * FROM letters WHERE sender = '$fullname'";
   ...
   if ($result->num_rows > 0) {
      ...
      while ($row = $result->fetch_assoc()) {
         ...
         echo "<td>$sentTo</td>";
         echo "<td>$subject</td>";
         echo "<td><button onclick=\"acceptAssignment('$serial')\">Track</button></td>";
         echo "</tr>";
      }
...
?>
   ...
   function acceptAssignment(id) {
      window.location.href = "letterTracking.php?id=" + id;
   }
</script>
